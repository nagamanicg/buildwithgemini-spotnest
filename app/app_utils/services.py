...
MEMORY_BANK_ID = "2132795272164540416"
...
def get_memory_service():
    """Process-wide Vertex AI Memory Bank service configured with the deployed Agent Engine."""
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-241dd311c4eb")
